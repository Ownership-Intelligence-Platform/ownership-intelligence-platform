// app.js (ES module)
// Extracted logic from inline <script> blocks in index.html
...
// ---- Ownership Layers Tree Rendering ----
...
export async function populateMock() {
...
// ---- Event Wiring ----
// Because the module is loaded at end of body, DOM elements exist already.
const populateBtn = document.getElementById("populate");
if (populateBtn) populateBtn.addEventListener("click", populateMock);
const clearBtn = document.getElementById("clearDb");
if (clearBtn) clearBtn.addEventListener("click", clearDb);
const loadLayersBtn = document.getElementById("loadLayers");
if (loadLayersBtn) loadLayersBtn.addEventListener("click", loadLayers);
const loadPenetrationBtn = document.getElementById("loadPenetration");
if (loadPenetrationBtn)
  loadPenetrationBtn.addEventListener("click", loadPenetration);
...
// Optionally expose selected functions to window for debugging
